<template>
  <div class="relative bg-white overflow-hidden h-screen">
      <div class="max-w-7xl mx-auto h-full">
          <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20  lg:w-full lg:pb-28 xl:pb-32 h-full">
                      ...
                      <div class=" flex justify-between items-center  border-gray-100 py-6  md:space-x-10">
                          <div class="flex justify-start items-center gap-12">
                              <a class="flex items-center" href="/">
                                  <img class="h-12 w-auto sm:h-12" src="/icons/rocket.svg" alt="site"/>
                                  <span class="text-indigo-600 ml-2 text-2xl font-bold">
                                      Tail-Kit
                                  </span>
                              </a>
                              <nav class="hidden md:flex space-x-10">
                                  <div class="relative">
                                      <button type="button" class="group bg-white rounded-md text-gray-800 inline-flex items-center text-base font-normal hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 text-xl">
                                          <span>
                                              Components
                                          </span>
              ...
              <main class="mt-10 mx-auto px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 h-full">
                  <div class="flex flex-col md:flex-row w-full items-start justify-between md:justify-start h-full md:h-1/2">
                      <div class="text-left z-20 md:z-30 w-full md:w-1/2 flex flex-col items-center md:items-start justify-start md:justify-center h-full">
                          <h1 class="tracking-tight font-extrabold text-gray-900 titleHome text-6xl ">
                          ...
                          <h2 class="mt-3  text-gray-500 sm:mt-5 text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                              ...
                              fully coded and responsive components and templates, based on Tailwind CSS 2.0. It&#x27;s all free and open-source.
                          </h2>
                          <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start w-full">
                              <div class="rounded-md shadow">
                                  <NuxtLink to="/tours/1" class="w-full flex items-center justify-center px-8 py-3  text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 px-4 py-2">
                                    Explore tours
                                  </NuxtLink>
                              </div>
                              <div class="mt-3 sm:mt-0 sm:ml-3">
                                  <a target="_blank" rel="noreferrer" href="https://github.com/Charlie85270/tail-kit" class="w-full flex items-center justify-center px-8 py-3  text-base font-medium rounded-md text-gray-800 bg-gray-100 hover:bg-gray-200 px-4 py-2">
                      ...
                      <div class="opacity-10 z-10 md:z-50 md:opacity-70 sm:text-center absolute lg:text-left transform  w-full -right-10 -top-72  md:w-1/2">
                          <div class="flex gap-4 gap-y-1">
                              ...
                              <div class="col-1">
                                  ...
                                  <div class="mb-4">
                                      <div class="shadow-lg rounded-2xl w-64 bg-white dark:bg-gray-800">
                                          <img alt="profil" src="/images/landscape/1.jpg" class="rounded-t-lg h-28 w-full mb-4"/>
                                          <div class="flex flex-col items-center justify-center p-4 -mt-16">
                                              <a href="#" class="block relative">
                                                  <img alt="profil" src="/images/person/1.jpg" class="mx-auto rounded-full h-16 w-16 "/>
                                              </a>
                                  ...
                                  <div class="mb-4">
                                      <div class="shadow-lg rounded-2xl p-4 bg-gray-900 w-64 m-auto relative">
                                          <div class="w-full h-full text-center">
                                              <div class="flex h-full flex-col justify-between">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="mt-4 w-20 h-20 m-auto text-white dark:text-white" viewBox="0 0 2048 1792">
                                                  ...
                                                  <p class="text-gray-50 text-xs font-thin py-2 px-6">
                                  ...
                                  <div class="mb-4">
                                      <div class="w-64">
                                          <div class="mt-1 relative">
                                              <button type="button" class="relative w-full bg-white rounded-md shadow-lg pl-3 pr-10 py-3 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                              ...
                              <div class="col-1">
                                  <div class="mb-4">
                                      <div class="shadow-lg rounded-2xl w-64 bg-indigo-500 dark:bg-gray-800 p-4">
                                          ...
                                          <button type="button" class="w-full px-3 py-3 text-sm shadow rounded-lg text-indigo-500 bg-white hover:bg-gray-100 ">
                                              Choose plan
                                          </button>
                                      </div>
                                  </div>
                                  ...
                                  <div class="mb-4">
                                      <div class="w-full mx-auto max-w-xl rounded-lg bg-white dark:bg-gray-800 shadow-lg px-5 py-4 text-gray-800 dark:text-gray-50">
                                          <div class="w-full pt-1 text-center -mt-16 mx-auto">
                                              <a href="#" class="block relative">
                                                  <img alt="profil" src="/images/person/1.jpg" class="mx-auto rounded-full h-20 w-20 "/>
                                              </a>
                                          </div>
                                          <div class="w-full">
